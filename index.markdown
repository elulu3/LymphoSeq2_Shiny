...
- *The intended data or graphical output*
...
*With this RData file, users can load data into their own R environment to explore the data further. Users can also re-upload this data into another instance of the Shiny application and eliminate the need for the application to process these summary data tables again on the same data set.*
