...
- *The intended tabular or graphical output*
- *The standardized AIRR-compliant data table of the uploaded dataset*
- *Datatable of productive amino acid sequences*
- *Datatable of productive nucleotide sequences*
- *Datatable of summary statistics*

*With this RData file, users can load data into their own R environment to explore the data further. Users can also re-upload this data into another instance of the Shiny application and eliminate the need for the application to recompute these summary data tables again on the same input data.*
...
- In each section, the corresponding LymphoSeq2 function will be shown
